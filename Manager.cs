...
using Player = FinalProject.Player;
...
namespace FinalProject
{
    ...
    public class Manager : MonoBehaviourPunCallbacks, IOnEventCallback
    {
        ...
        private void Leaderboard (Transform p_lb)
        {
            ...
            if (GameSettings.GameMode == GameMode.CAPTUREFLAG) p_lb = p_lb.Find("CaptureTheFlag");
            ...
            // set scores
            if (GameSettings.GameMode == GameMode.CAPTUREFLAG)
            {
